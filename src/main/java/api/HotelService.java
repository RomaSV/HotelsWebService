...
public interface HotelService {
    ...
    HotelData getHotel(@PathVariable("hotelId") Long hotelId);
    ...
    List<RoomData> getRooms(@PathVariable("hotelId") Long hotelId, @RequestBody Map<String, String> params);
    ...
    RoomData getRoom(@PathVariable("hotelId") Long hotelId, @PathVariable("roomId") Integer roomId);
    ...
    HotelData addHotel(@RequestParam String adminName);
    ...
    RoomData addRoom(@PathVariable("hotelId") Long hotelId, RoomUpdateRequest request);
    ...
    HotelData updateHotel(@PathVariable("hotelId") Long hotelId, HotelUpdateRequest request);
    ...
    RoomData updateRoom(@PathVariable("hotelId") long hotelId, @PathVariable("roomId") int roomId, RoomUpdateRequest request);
